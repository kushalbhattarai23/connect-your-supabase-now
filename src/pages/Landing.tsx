...
export const Landing: React.FC = () => {
  ...
  if (!user) {
    return (
      <>
        <Helmet>
          <title>Track Hub – Ultimate Dashboard for TV Shows and Finances</title>
          <meta name="description" content="Track Hub is your all-in-one dashboard to organize TV universes and manage your finances. Free to get started." />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>Welcome Back – Track Hub Dashboard</title>
        <meta name="description" content="Choose an app to organize your TV shows, finances, and more from a single powerful dashboard." />
      </Helmet>
